...
for f in glob.glob("Matrices/*behavioralout.txt"):
	...
	with open(f, 'r') as csvfile:
		...
		dfTemp = pd.read_csv(csvfile, delimiter='\t', header=None, names=['Trial', 'CorrectAnswer', 'SolutionClicked', 'SubjectResponse', 'RT_Solving', 'RT_SolvingUnc', 'RT_Response', 'RT_ResponseUnc', 'OrderSolutions'] )
